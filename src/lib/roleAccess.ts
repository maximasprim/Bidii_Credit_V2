...
export const ADMIN_ROLES: { value: AdminRole; label: string }[] = [
  ...
  { value: "check_off_agent", label: "Check Off Agent" },
  { value: "logbook_agent", label: "Logbook Agent" },
  { value: "rental_loan_agent", label: "Rental Loan Agent" },
  { value: "sme_loan_agent", label: "SME Loan Agent" },
  { value: "mobile_loan_agent", label: "Mobile Loan Agent" },
];
...
export const MENU_REGISTRY: { path: string; label: string }[] = [
  ...
  { path: "/admin/loan-routing", label: "Loan Routing" },
